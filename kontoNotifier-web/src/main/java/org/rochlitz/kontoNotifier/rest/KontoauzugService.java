...
//   http://localhost:8080/kontoNotifier-web/rest/kontoauzug
@Path("/kontoauzug")
@Stateless
public class KontoauzugService {
	...
	public Response getKontoAuszug(KontoDTO konto, @Context HttpServletRequest request) {
		...
		try {
			...
			KontoauszugDTO kauz = kDAO.getLatestKontauszugOfUser(user);
			
			builder = Response.ok().entity(kauz);
